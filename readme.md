...
Use the phin library to fetch the specified URL (```opts``` gets passed on to the ```phin()``` call), and call the function with the result (either an error or the data).
